...
- ファイル関連付けサポート（「アプリで開く」メニューに追加）
- メニューバー（ファイル、ツール、ヘルプ）
- カスタムアプリアイコン付き

## v1.1.0 の新機能

- メニューバーを追加（ファイル、ツール、ヘルプ）
- ステータスバーにズームレベルを表示
- ファイル関連付け機能を追加（ツール → デフォルトの画像ビューアに設定）
- 「GitHub を開く」メニュー項目を追加
- バージョン情報を表示する「About」ダイアログを追加
- 各種 UI の改善
...
解凍して `Noctis_Viewer.exe` を実行するだけ。インストール不要です。
...
このプロジェクトは MIT License を採用しています。詳細は [LICENSE] を参照してください。
